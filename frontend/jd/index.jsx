...
import VideoSession from '../../rightsidebar/videoSession.jsx';
import SessionManager from '../../rightsidebar/SessionManager.jsx';
...
export default function RightSidebar({ analysisData, hasGeneratedDashboard,selectedDashboardId,setSelectedDashboardId,selectedFile }) {
  ...
  useEffect(() => {
    console.log('[RightSidebar] 📦 analysisData received:', analysisData);
    if (analysisData && !processedRef.current) {
